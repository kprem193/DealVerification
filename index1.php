...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<h4><i class="icon-envelope"></i><strong>Feature Extraction</strong></h4>
...
<?php
$a= file_get_contents("/var/www/html/LargeDeal/spacy.txt");
echo "<p style='color:red; margin-left:15rem; margin-right:15rem; font-size:30px; font-family: Montserrat sans-serif;'><strong>Feature Extraction</strong> :<br></p>";
echo "<p style='color:black; margin-left:15rem; margin-right:15rem; font-size:20px;font-family: Montserrat sans-serif;'><pre> $a </pre></p>";
...
if (isset($name)) 
{
    ...
    {
        $location = 'uploads/';
        if(move_uploaded_file($tmp_name, $location."spacy.txt")) 
        {
            echo "Uploaded!";
            echo "hello World";
           $result = shell_exec('/var/www/html/LargeDeal/spacy_shell_scripting.sh ');
		   echo $result;
